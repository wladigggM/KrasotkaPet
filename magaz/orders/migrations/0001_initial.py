# Generated by Django 4.2.7 on 2024-03-21 11:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_address', models.CharField(blank=True, max_length=150, null=True, verbose_name='Адрес доставки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='mainApp.item', verbose_name='Товар')),
            ],
            options={
                'verbose_name': 'Проданый товар',
                'verbose_name_plural': 'Проданые тоары',
                'db_table': 'order_item',
            },
        ),
    ]
